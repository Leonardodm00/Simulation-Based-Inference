...
# --------------------------------------------------------------------------- #
# CohortConfig lives in cohort.py since Stage D (2026-09-21) so that the
# extractor can read it without torch; it is re-exported here unchanged.
from cohort import CohortConfig  # noqa: E402,F401
